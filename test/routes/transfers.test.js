...
describe('Ao salvar uma transfência válida... ', () => {
  let transferId;
  let income;
  let outcome;
  ...
  test('Ambas devem referencias a transferencia que as originou', () => {
    expect(income.transfer_id).toBe(transferId);
    expect(outcome.transfer_id).toBe(transferId);
  });
});

describe('Ao tentar salver uma transferência invalida...', () => {
...
describe('Ao alterar uma transfência válida... ', () => {
  let transferId;
  let income;
  let outcome;
  ...
  test('Ambas devem estar com o status de realizado', () => {
    expect(income.status).toBe(true);
    expect(outcome.status).toBe(true);
  });
});

describe('Ao tentar alterar uma transferência invalida...', () => {
  const validTransfer = { description: 'Regular Transfer', user_id: 10000, acc_ori_id: 10000, acc_dest_id: 10001, amount: 100, date: new Date() };
